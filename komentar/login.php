...
if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
  header("location: ../komentar/dashboard.php");
  exit;
}
      ...
      <section class="mb-5 pb-5">
        <div class="container-fluid h-custom">
            ...
            <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="text" name="username" class="form-control form-length" value="<?php echo $username; ?>">
            ...
            <div class="form-group button-position">
                <input type="submit" class="btn btn-primary button-position" value="Login">
            </div>
        </form>
                </div>
            </div>
